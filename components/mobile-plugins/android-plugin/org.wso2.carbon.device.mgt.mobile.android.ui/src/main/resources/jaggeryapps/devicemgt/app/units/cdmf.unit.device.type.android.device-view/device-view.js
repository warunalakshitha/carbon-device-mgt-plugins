...
// creating deviceView information model from filtered device data
        ...
        var realtimeEndpoint = devicemgtProps["adminService"].replace("https", "wss");
        ...
        if (encodedClientKeys) {
            ...
            realtimeEndpoint = realtimeEndpoint + "/realtime-operations/" + deviceType
                "/" + deviceId + "?websocketToken=" + token
        deviceViewData["realtimeEndpoint"] = realtimeEndpoint;
    }
